...
import {
  ...
  Eye, Camera, CheckCircle, DollarSign, Briefcase, CalendarDays, RadioTower, Presentation, NotebookPen,
} from "lucide-react";
...
const snippetPrimaryColor = '#4F46E5'; // Color from the example snippet
...
export default function TutorDashboardPage() {
  ...
  const [mockDaysLeft, setMockDaysLeft] = useState(0); // Initialize with 0

  useEffect(() => {
    setIsClient(true);
    // Generate random days left only once on client mount
  ...
  const pagePrimaryColor = '#4F46E5'; // Defined from snippet

  const dashboardMetrics = [
    { title: "Total Enquiries", value: "15", trend: "2 new", IconEl: Briefcase, iconBg: "bg-blue-50", iconColor: `text-[${pagePrimaryColor}]`, trendColor: "text-green-600", TrendIconEl: ArrowUp },
    ...
    { title: "Avg. Rating", value: tutorUser.rating?.toFixed(1) || "N/A", trend: "+0.1", IconEl: Star, iconBg: `bg-[${pagePrimaryColor}]/10`, iconColor: `text-[${pagePrimaryColor}]`, trendColor: "text-green-600", TrendIconEl: ArrowUp },
  ...
  const quickActions = [
     { title: "My Enquiries", description: "View and manage student enquiries.", IconEl: Briefcase, iconBg: "bg-blue-50", iconTextColor: `text-[${pagePrimaryColor}]`, href:"/dashboard/enquiries" },
     ...
     { title: "Settings", description: "Adjust your account preferences.", IconEl: Settings2Icon, iconBg: "bg-yellow-50", iconTextColor: "text-yellow-600", href: "#" },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-6 md:py-8"> {/* Added responsive padding */}
          {/* Welcome Section */}
          <div className="bg-card rounded-xl shadow-lg p-6 md:p-8 mb-6 md:mb-8 border-0"> {/* Removed border */}
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                <div className="relative group">
                  ...
                  <button
                    ...
                    className="absolute -bottom-2 -right-2 flex items-center justify-center bg-primary text-primary-foreground p-2 rounded-full cursor-pointer shadow-md hover:bg-primary/90 transition-colors"
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 mt-4 md:mt-0">
                ...
                <div className="flex flex-col xs:flex-row gap-3 w-full sm:w-auto">
                    <Button className="text-white px-4 py-2 rounded-button whitespace-nowrap hover:bg-opacity-90 transition-colors w-full xs:w-auto text-sm font-medium" style={{ backgroundColor: snippetPrimaryColor }}>
                        Upgrade Plan
                    </Button>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-5 mb-6 md:mb-8">
            {dashboardMetrics.map((metric, index) => (
              <div key={index} className="bg-card rounded-xl shadow-lg p-4 border-0"> {/* Removed border */}
                <div className="flex items-start justify-between">
                  <div>
                  ...
                  <div className={cn("w-8 h-8 flex items-center justify-center rounded-lg text-sm shrink-0", metric.iconBg, metric.iconColor)}>
          ...
          {/* Chart Placeholders - These would need actual chart components */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 mb-6 md:mb-8">
            <div className="bg-card rounded-xl shadow-lg p-6 md:p-8 lg:col-span-2 border-0"> {/* Removed border */}
            ...
            <div className="bg-card rounded-xl shadow-lg p-6 md:p-8 border-0"> {/* Removed border */}
          ...
          <div className="mb-6 md:mb-8">
            <h2 className="text-md md:text-lg font-semibold text-foreground mb-4 md:mb-5">Quick Actions</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-5">
              {quickActions.map((action, index) => (
                <Link key={index} href={action.href || "#"} className="block">
                  <div className="bg-card rounded-xl shadow-lg p-5 hover:shadow-2xl transition-shadow cursor-pointer h-full flex flex-col justify-between transform hover:-translate-y-1 border-0"> {/* Removed border */}
                    <div>

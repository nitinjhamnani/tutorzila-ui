...
export function TutorProfileCard({ tutor }: TutorProfileCardProps) {
  return (
    <Card className="group shadow-md hover:shadow-lg transition-all duration-300 flex flex-col transform hover:scale-102 hover:-translate-y-0.5 bg-card h-full min-h-[15rem]">
      ...
      <CardContent className="space-y-2 text-xs flex-grow p-4 pt-1 md:p-5 md:pt-1"> {/* Increased space-y from 1 to 2 */}

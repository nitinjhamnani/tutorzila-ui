...
const parentTicketCategories = {
  "Payment": ["Fee Discrepancy", "Transaction Failed", "Refund Query"],
  "Tutor": ["Tutor Communication Issue", "Feedback on a Tutor", "Request Tutor Change"],
  "Demo Session": ["Scheduling Problem", "Technical Difficulties", "Demo Not Conducted"],
  "Platform": ["Technical Issue", "Account Help", "General Feedback"],
  "Others": ["Other"],
};
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <Select onValueChange={(value) => { field.onChange(value); form.setValue("subject", ""); }} value={field.value}>
                            ...
                            <SelectContent>
                              {Object.keys(parentTicketCategories).map(cat => (
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <Select onValueChange={field.onChange} value={field.value} disabled={!selectedCategory}>
                            ...
                            <SelectContent>
                              {selectedCategory && parentTicketCategories[selectedCategory as keyof typeof parentTicketCategories].map(subj => (

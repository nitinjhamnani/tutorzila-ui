...
import { CalendarDays, CheckCircle, ChevronDown, ListFilter, MessageSquareQuote, PlusCircle, XCircle, Clock } from "lucide-react"; // Added Clock
  ...
  return (
    <main className="flex-grow">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-6 md:py-8">
        <BreadcrumbHeader segments={[{ label: "Dashboard", href: "/tutor/dashboard" }, { label: "Demo Sessions" }]} />

...
export default function TutorSpecificLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex flex-col min-h-screen">
            ...
            <div className="flex items-center gap-2 md:gap-3">
              ...
              {user && (
               ...
               <Button
                  ...
                  size="sm"
                  onClick={logout}
                  className="text-xs h-8 hidden md:flex items-center"
                >
      ...
      <div className={cn("flex flex-1 overflow-hidden items-stretch")}> {/* Removed h-full from here */}
          <TutorSidebar 
            isMobile={isMobile}
            isMobileNavOpen={isMobileNavOpen}
            isNavbarCollapsed={isNavbarCollapsed}
            toggleNavbarCollapsed={toggleNavbarCollapsed} // Keep for desktop collapse inside TutorSidebar
            toggleMobileNav={toggleMobileNav} // Keep for mobile sheet close inside TutorSidebar
          ...
          <main className={cn(
            ...
            "pb-4 md:pb-6 px-4 md:px-6",
             paddingTopForContentArea // This should push content below the header
          )}>

...
import { SearchIcon, XIcon, ListChecks, FilterIcon as LucideFilterIcon, Star, CheckCircle, Inbox } from "lucide-react"; // Changed StarIcon to Star
...
export default function AllEnquiriesPage() {
  ...
  useEffect(() => {
    // Filter open requirements initially for the "Recommended" tab or as a base
  ...
  const tabCounts = {
    recommended: filteredRequirements.length, // This will be all open requirements based on current logic
    applied: 0, // Placeholder - assuming no specific "applied" status on TuitionRequirement
    received: 0, // Placeholder - assuming this is for parent context, might need different logic
      ...
      <Card className="text-center py-12 bg-card border rounded-lg shadow-sm animate-in fade-in zoom-in-95 duration-500 ease-out overflow-hidden">
        <CardContent className="flex flex-col items-center">
          ...
          <p className="text-sm text-muted-foreground max-w-sm mx-auto">
            There are no enquiries in this category. Try adjusting your search filters or check back later.
          </p>

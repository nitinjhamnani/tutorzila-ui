...
import {
  ...
  Ruler, FilterIcon, UploadCloud, Palette, Link as LinkIcon, UserPlus,
  ...
  Presentation, Camera, Star, Percent, Clock, ShoppingBag, HardDrive, Crown, Share2, Bell, MessageSquare, ArrowRight
} from "lucide-react";
          ...
          <div className="bg-card rounded-xl shadow-lg p-6 md:p-8 mb-6 md:mb-8 border-0">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-center">
                <div className="bg-secondary rounded-lg p-4 w-full sm:min-w-0">
                  <div className="flex items-start justify-between">
                    <div>
